...
<section class="reason">
    <div class="container">
        <div class="section_label">преимущества</div>
        <div class="section_title reason_title">8 причин начать работать с нами</div>
        <div class="row">
            <div class="col-md-6">
                <div class="reason_block">
                    <div class="reason_round">
                        <img src="icons/reason/reason-1.png" alt="">
                    </div>
                    <div class="reason_descr">
                        <div class="reason_subtitle">Никаких наличных, оплата происходит
                            автоматически</div>
                        <div class="reason_text">
                            Стоимость поездки оплачивается пассажиром с
                            привязанной банковской карты, т.е. нет никаких рисков связанных с
            ...
            <div class="col-md-6">
                <div class="reason_block">
                    <div class="reason_round">
                        <img src="icons/reason/reason-2.png" alt="">
                    </div>
                    <div class="reason_descr">
            ...
            <div class="col-md-6">
                <div class="reason_block">
                    <div class="reason_round">
                        <img src="icons/reason/reason-3.png" alt="">
                    </div>
                    <div class="reason_descr">
                        <div class="reason_subtitle">Высокий доход с гарантированными
                            выплатами</div>
            ...
            <div class="col-md-6">
                <div class="reason_block">
                    <div class="reason_round">
                        <img src="icons/reason/reason-4.png" alt="">
                    </div>
                    <div class="reason_descr">
                        <div class="reason_subtitle">Работа в удобное время, никаких
                            графиков</div>
                        <div class="reason_text">Вы просто нажимаете кнопку выйти на линию для начала работы, когда решите закончить, нажимаете выйти с линии. Вы можете подрабатывать только утром, вечером, в выходные или праздничные дни! </div>
                    </div>
                </div>
            </div>
            <div class="col-md-6">
                <div class="reason_block">
                    <div class="reason_round">
                        <img src="icons/reason/reason-5.png" alt="">
                    </div>
                    <div class="reason_descr">
                        <div class="reason_subtitle">Комфортное, прозрачное и простое
                            подключение</div>
            ...
            <div class="col-md-6">
                <div class="reason_block">
                    <div class="reason_round">
                        <img src="icons/reason/reason-6.png" alt="">
                    </div>
                    <div class="reason_descr">
            ...
            <div class="col-md-6">
                <div class="reason_block">
                    <div class="reason_round">
                        <img src="icons/reason/reason-7.png" alt="">
                    </div>
                    <div class="reason_descr">
            ...
            <div class="col-md-6">
                <div class="reason_block">
                    <div class="reason_round">
                        <img src="icons/reason/reason-8.png" alt="">
                    </div>
                    <div class="reason_descr">
...
<section class="choice">
    <div class="container">
        <div class="black"></div>
        <div class="section_label section_label_white">Возможности</div>
        <div class="section_title section_title_white">Выбор - отличная штука!</div>
        <div class="section_subtitle section_subtitle_white">Закажите автомобиль, который подходит вам по стилю и бюджету</div>

        <img src="img/uber-car.png" alt="uber car" class="choice_img">
...
<section class="require" id="require">
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="require_block">
                    <div class="require_title require_title_red">
                        ТРЕБОВАНИЕ:
                    </div>
                    <ul class="require_list require_list_red">
                        ...
                        <li>Дивайс на системе андроид 4.0 и<br>выше(самсунг)</li>
                    </ul>
                </div>
            </div>
            <div class="col-md-6">
...
<section class="map">
    <div class="container">
        <div class="section_label section_label_white">города</div>
        <div class="section_title section_title_white">по всему миру</div>
        <div class="section_subtitle section_subtitle_white">по всему миру</div>
    ...
    <div class="footer_wrapper">
        ...
        <div>
            <div class="footer_mobile">
                ...
                <a href="#">
                    <img src="img/footer/windows-store.png" alt="Windows store">
                </a>
            </div>
        </div>
    </div>
